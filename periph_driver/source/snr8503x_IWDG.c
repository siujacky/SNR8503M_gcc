...
/*******************************************************************************
 ...
 修改日期      版本号          修改人            修改内容
 -----------------------------------------------------------------------------
 2021/11/09    V1.0           Li              创建
 *******************************************************************************/
void IWDG_StrutInit(IWDG_InitTypeDef *this)
{
    this->DWK_EN = DISABLE;             // 深度休眠定时唤醒不使能
    this->WDG_EN = DISABLE;             // 独立看门狗不使能
    this->WTH = SECOND2IWDGCNT(1.5);      // 看门狗定时唤醒时间,大于复位时间后无效
